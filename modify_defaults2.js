...
content = replaceConstant(content, 'export const DEFAULT_PROFILESCREEN_SOURCE', replacement1);
content = replaceConstant(content, 'export const DEFAULT_COMMUNITYCHATSCREEN_SOURCE', replacement3);
content = replaceConstant(content, 'export const DEFAULT_COMMUNITYPROFILESCREEN_SOURCE', replacement2);
